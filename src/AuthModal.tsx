...
import { checkUserByEmail, registerUser } from "./requests";
...
export const AuthModal: React.FC<AuthModalProps> = ({ onClose }) => {
	...
	return (
		<div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
			<div className={`bg-white flex flex-col p-4 rounded-[4rem] ${step === 1 || step === 2 ? 'h-[31.875rem] w-[37.5rem]' : 'h-[38.625rem] w-[44.375rem]'}  relative justify-center items-center gap-10`}>
				<button
