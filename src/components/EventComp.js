...
const genClasses = "h-8 px-1.5 py-0.5 rounded-lg justify-start items-center gap-2 inline-flex text-left text-8 font-medium leading-7 mb-1 cursor-pointer";
const propertyComp = {
...
const whatFigure = {
    circle: _jsx("div", { className: "p-px text-red-600 justify-center items-center flex", children: "\u25CF" }),
    star: _jsx("div", { className: "p-px text-white justify-center items-center flex", children: "\u2726" })
};
export const EventComponent = ({ dateStart, label, onEvent, figure, ...props }) => {
    ...
    return (_jsxs("div", { className: `${allClasses} max-w-[100%] w-fit`, ...props, children: [fig, _jsx("span", { className: 'truncate', children: label })] }));
};
