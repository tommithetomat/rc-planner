import { format, DateType } from "date-fns";

import { ru } from "date-fns/locale";

export const formatMonth = (date: DateType) =>
	format(date, "LLLL", { locale: ru });

export const formatDay = (date: DateType) => {
...
export const arrowLeft = (
	...
	>
		<path
			d="M19 6L9.70711 15.2929C9.31658 15.6834 9.31658 16.3166 9.70711 16.7071L19 26"
			stroke="#0D0C0C"
			stroke-width="4"
...
export const arrowRight = (
	...
	>
		<path
			d="M13 6L22.2929 15.2929C22.6834 15.6834 22.6834 16.3166 22.2929 16.7071L13 26"
			stroke="#0D0C0C"
			stroke-width="4"
			stroke-linecap="round"
		/>
